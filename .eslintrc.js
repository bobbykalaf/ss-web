module.exports = {
	...
	rules: {
		...
		'prefer-destructuring': [2, 'always'],
		'prefer-rest-params': [2, 'always'],
		'prefer-spread': [2, 'always'],
		'prefer-template': [2, 'always'],
		'sort-imports': [2, { ignoreCase: true, memberSyntaxSortOrder:  [ "multiple", "single", "all", "none" ] }]
	}
};
